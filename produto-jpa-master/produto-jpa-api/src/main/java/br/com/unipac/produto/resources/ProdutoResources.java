package br.com.unipac.produto.resources;
...
public class ProdutoResources {
	...
	@ResponseBody
	public ResponseEntity<List<Produto>> getUserByUsername(@PathVariable("name") String nomeProduto) {
		List<Produto> produtos = service.findByNome(nomeProduto);
